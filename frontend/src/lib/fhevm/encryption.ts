 ...
 */
export function setFHEVMInstanceGetter(getter: () => any): void {
 ...
 */
async function performAsyncEncryption(input: any): Promise<any> {
 ...
 */
function createEncryptedInput(fhevmInstance: any, params: EncryptionParams): any {
  ...
  try {
    ...
    return fhevmInstance.createEncryptedInput(params.contractAddress, params.userAddress);
  } catch (error) {
